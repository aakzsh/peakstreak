...
class EditChallenge extends StatefulWidget {
    const EditChallenge({super.key, required this.index, required this.tasks, required this.data, required this.allTasks});
  final int index;
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    Container(
                      width: w - 40,
                       height: widget.tasks.length*25 > 60 ? widget.tasks.length*25 : 60,
                            ...
                            itemBuilder: ((context, index) 
                                {
                                 return   GestureDetector(
                                      onTap: ()async{
                                        setState(() {
                                          widget.tasks[index] = widget.tasks[index]=="0"?"1":"0";
                                        });
                                        
                                        await updateChallengeData(widget.tasks);
                                      },
                                      child: widget.tasks[index]=="0"?Text(widget.allTasks[index], style: const TextStyle(color: AppColors.brightred,),):Text(widget.allTasks[index], style: const TextStyle(
